...
namespace rf_yaml {
	...
	class LexerYaml : public reflex::AbstractLexer<reflex::Matcher> {
	  ...
	  public:
		LexerYaml(const char* input, size_t input_size)
		  : LexerYaml(reflex::Input(input, input_size)) {
		}
	  ...
	  public:
		...
		LexerYaml(const reflex::Input& input = reflex::Input(), std::ostream& os = std::cout)
